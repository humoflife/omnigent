...
class ElicitationRequest:
    ...
    # with Discord components (a non-empty requestedSchema that isn't AskUserQuestion).
    ...
    def is_supported(self) -> bool:
        """Whether the bot can render this elicitation natively in Discord.
...
def extract_elicitation_resolved(event: dict[str, Any]) -> str | None:
    ...
    The server pushes this when an elicitation is resolved — by our own Discord
